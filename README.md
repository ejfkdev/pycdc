...
### 行为等价矩阵（`tools/run_behavior.py`，42 用例 × 13 解释器）
...
|---|---|---|---|
| 2.6 | 25/25 | 3.9 | 35/35 |
| 2.7 | 26/26 | 3.10 | 37/37 |
| 3.3 | 27/27 | 3.11 | 40/40 |
| 3.5 | 29/29 | 3.12 | 41/41 |
| 3.6 | 30/30 | 3.13 | 41/41 |
| 3.7 | 30/30 | 3.14 | 41/41 |
| 3.8 | 35/35 | **合计** | **437/437 = 100%** |
