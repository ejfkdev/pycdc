...
def html(einfo, context=5):
    ...
    for frame, file, lnum, func, lines, index in records:
        ...
        call = ''
        if func != '?':
            call = time.ctime + ('in ' + strong(pydoc.html.escape(func)))(args, varargs, varkw, locals, lambda value: '=' + pydoc.html.repr(value), formatvalue=inspect.formatargvalues)
        highlight = {}
...
def text(einfo, context=5):
    ...
    for frame, file, lnum, func, lines, index in records:
        ...
        call = ''
        if func != '?':
            call = time.ctime + ('in ' + func)(args, varargs, varkw, locals, lambda value: '=' + pydoc.text.repr(value), formatvalue=inspect.formatargvalues)
        highlight = {}
        def reader(lnum=[lnum]):
            highlight[lnum[0]] = 1
            try:
