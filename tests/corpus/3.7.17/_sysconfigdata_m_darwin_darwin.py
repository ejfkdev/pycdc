...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '~/.pyenv/versions/3.7.17/bin',
 'BINLIBDEST': '~/.pyenv/versions/3.7.17/lib/python3.7',
 ...
 'BLDSHARED': 'clang -bundle -undefined dynamic_lookup '
              ...
              '-L~/.pyenv/versions/3.7.17/lib '
              '-Wl,-rpath,~/.pyenv/versions/3.7.17/lib -isysroot '
 ...
 'CONFIGURE_CPPFLAGS': '-I/opt/homebrew/opt/ncurses/include '
                       ...
                       '-I~/.pyenv/versions/3.7.17/include '
 ...
 'CONFIGURE_LDFLAGS': '-L/opt/homebrew/opt/ncurses/lib '
                      ...
                      '-Wl,-rpath,/opt/homebrew/opt/openssl@3/lib '
                      '-L~/.pyenv/versions/3.7.17/lib '
                      '-Wl,-rpath,~/.pyenv/versions/3.7.17/lib '
                      '-isysroot '
                      '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.5.sdk '
                      '-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=~/.pyenv/versions/3.7.17' '--enable-shared' "
                "'--libdir=~/.pyenv/versions/3.7.17/lib' "
                ...
                '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.5.sdk '
                "-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib' "
                "'LIBS=-L~/.pyenv/versions/3.7.17/lib "
                '-Wl,-rpath,~/.pyenv/versions/3.7.17/lib '
                "-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib' "
 ...
 'CONFINCLUDEDIR': '~/.pyenv/versions/3.7.17/include',
 'CONFINCLUDEPY': '~/.pyenv/versions/3.7.17/include/python3.7m',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-I. -I./Include -I/opt/homebrew/opt/ncurses/include '
             ...
             '-I/opt/homebrew/include',
 'CXX': 'clang++',
 'DESTDIRS': '~/.pyenv/versions/3.7.17 '
             '~/.pyenv/versions/3.7.17/lib '
             '~/.pyenv/versions/3.7.17/lib/python3.7 '
             '~/.pyenv/versions/3.7.17/lib/python3.7/lib-dynload',
 'DESTLIB': '~/.pyenv/versions/3.7.17/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '~/.pyenv/versions/3.7.17/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '~/.pyenv/versions/3.7.17/include '
                   '~/.pyenv/versions/3.7.17/include '
                   '~/.pyenv/versions/3.7.17/include/python3.7m '
                   '~/.pyenv/versions/3.7.17/include/python3.7m',
 'INCLUDEDIR': '~/.pyenv/versions/3.7.17/include',
 'INCLUDEPY': '~/.pyenv/versions/3.7.17/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '~/.pyenv/versions/3.7.17/lib/python3.7',
 'LIBDIR': '~/.pyenv/versions/3.7.17/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '~/.pyenv/versions/3.7.17/lib/pkgconfig',
 'LIBPL': '~/.pyenv/versions/3.7.17/lib/python3.7/config-3.7m-darwin',
 'LIBRARY': 'libpython3.7m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lintl -ldl -L~/.pyenv/versions/3.7.17/lib '
         '-Wl,-rpath,~/.pyenv/versions/3.7.17/lib -L/opt/homebrew/lib '
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '~/.pyenv/versions/3.7.17/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '26.6',
 'MAINCC': 'clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '~/.pyenv/versions/3.7.17/share/man',
 ...
 'SCRIPTDIR': '~/.pyenv/versions/3.7.17/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 'SHLIBS': '-lintl -ldl -L~/.pyenv/versions/3.7.17/lib '
           '-Wl,-rpath,~/.pyenv/versions/3.7.17/lib -L/opt/homebrew/lib '
           '-Wl,-rpath,/opt/homebrew/lib -framework CoreFoundation',
 'SHLIB_SUFFIX': '.so',
 ...
 'datarootdir': '~/.pyenv/versions/3.7.17/share',
 'exec_prefix': '~/.pyenv/versions/3.7.17',
 'prefix': '~/.pyenv/versions/3.7.17',
 'srcdir': '.'}
