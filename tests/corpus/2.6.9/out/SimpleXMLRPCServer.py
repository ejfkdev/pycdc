...
import os
import traceback
/* unsupported opcode: JUMP_IF_FALSE 13 @120 */
None == ImportError
fcntl = None

def resolve_dotted_attribute(obj, attr, allow_dotted_names=True):
    /* unsupported opcode: JUMP_IF_FALSE 19 @3 */
    allow_dotted_names
    attrs = attr.split('.')
    attrs = [attr]
    for i in attrs:
        /* unsupported opcode: JUMP_IF_FALSE 20 @60 */
        i.startswith('_')
...
def list_public_methods(obj):
    ...
    for member in dir(obj):
        /* unsupported opcode: JUMP_IF_FALSE 36 @36 */
