...
build_time_vars = {
    ...
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15/lcov-report',
    ...
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall',
    'PY_CFLAGS_NODIST': '-I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15/code.profclangd -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include -DPy_BUILD_CORE',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15 ./python.exe -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15 ./python.exe -E -m test',
    ...
    'abs_builddir': '/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15',
    'abs_srcdir': '/private/tmp/pythonA3.13-20260805-4649-k0luva/Python-3.13.15',
