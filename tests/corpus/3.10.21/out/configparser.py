...
class ParsingError(Error):
    ...
    @property
    def filename(self):
        None("The 'filename' attribute will be removed in Python 3.12. Use 'source' instead.", DeprecationWarning, 2, stacklevel=warnings.warn)
        return self.source
...
class RawConfigParser(MutableMapping):
    ...
    def readfp(self, fp, filename=None):
        None("This method will be removed in Python 3.12. Use 'parser.read_file()' instead.", DeprecationWarning, 2, stacklevel=warnings.warn)
...
class SafeConfigParser(ConfigParser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        None('The SafeConfigParser class has been renamed to ConfigParser in Python 3.2. This alias will be removed in Python 3.12. Use ConfigParser directly instead.', DeprecationWarning, 2, stacklevel=warnings.warn)
